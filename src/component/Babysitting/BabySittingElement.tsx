        ...
        <>
            <tr>
                ...
                <td className={"px-2 border border-slate-700"}>
                    <button className={"px-3 py-1 text-sm text-blue-600 font-semibold rounded-full  hover:text-white hover:bg-blue-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"}
