    ...
    return (
        <section className={"p-2 border flex justify-between"}>
            ...
            <div className={"flex"}>
                ...
                <button className={"px-3 py-1 text-sm text-blue-600 font-semibold rounded-full md:hidden " +
                ...
                <div className={"flex hidden md:block"}>
                    ...
                    <button className={"px-3 py-1 text-sm text-red-600 font-semibold rounded-full" +
